<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">基于微信小程序的新生自助报到系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="院系" class="input" v-if="tableName=='zhiyuanzhe'">
			...
			<el-form-item label="电话" class="input" v-if="tableName=='zhiyuanzhe'">
