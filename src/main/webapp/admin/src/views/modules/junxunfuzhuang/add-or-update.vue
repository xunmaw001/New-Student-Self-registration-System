<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="服装名称" prop="fuzhuangmingcheng">
          <el-input v-model="ruleForm.fuzhuangmingcheng" 
              placeholder="服装名称" clearable  :readonly="ro.fuzhuangmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="服装名称" prop="fuzhuangmingcheng">
              <el-input v-model="ruleForm.fuzhuangmingcheng" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="服装颜色" prop="fuzhuangyanse">
          <el-input v-model="ruleForm.fuzhuangyanse" 
              placeholder="服装颜色" clearable  :readonly="ro.fuzhuangyanse"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="服装颜色" prop="fuzhuangyanse">
              <el-input v-model="ruleForm.fuzhuangyanse" 
                placeholder="服装颜色" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="服装材料" prop="fuzhuangcailiao">
          <el-input v-model="ruleForm.fuzhuangcailiao" 
              placeholder="服装材料" clearable  :readonly="ro.fuzhuangcailiao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="服装材料" prop="fuzhuangcailiao">
              <el-input v-model="ruleForm.fuzhuangcailiao" 
                placeholder="服装材料" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="服装详情" prop="fuzhuangxiangqing">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.fuzhuangxiangqing" label="服装详情" prop="fuzhuangxiangqing">
                    <span v-html="ruleForm.fuzhuangxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.fuzhuangxiangqing = this.ruleForm.fuzhuangxiangqing.replace(reg,'../../../ssmg48yd/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `junxunfuzhuang/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.junxunfuzhuangCrossAddOrUpdateFlag = false;
						 this.parent.search();
