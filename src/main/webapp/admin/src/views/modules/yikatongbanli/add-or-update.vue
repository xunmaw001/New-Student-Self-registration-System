<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="一卡通账号" prop="yikatongzhanghao">
            <el-input v-model="ruleForm.yikatongzhanghao" 
                placeholder="一卡通账号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.yikatongzhanghao" label="一卡通账号" prop="yikatongzhanghao">
              <el-input v-model="ruleForm.yikatongzhanghao" 
                placeholder="一卡通账号" readonly></el-input>
          </el-form-item>
        </div>
...
export default {
  data() {
	...
	shhf : false,
      ...
      rules: {
          yikatongzhanghao: [
                { required: true, message: '一卡通账号不能为空', trigger: 'blur' },
          ],
          shenqingshijian: [
          ],
          shenqingshuoming: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='yikatongzhanghao'){
            this.ruleForm.yikatongzhanghao = obj[o];
	    this.ro.yikatongzhanghao = true;
            continue;
          }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `yikatongbanli/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.yikatongbanliCrossAddOrUpdateFlag = false;
						 this.parent.search();
