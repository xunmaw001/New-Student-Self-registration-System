  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='zhiyuanzhe'"  label="院系" prop="yuanxi">
          <el-input v-model="ruleForm.yuanxi"               placeholder="院系" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='zhiyuanzhe'"  label="电话" prop="dianhua">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='zhiyuanzhe'"  label="备注" prop="beizhu">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.xingbie)&& 'zhiyuanzhe'==this.flag){
      ...
      if( 'zhiyuanzhe' ==this.flag && this.ruleForm.dianhua&&(!isMobile(this.ruleForm.dianhua))){
